...
<details open>
<summary><b>📂 目錄、索引用 Repo</b></summary>
<br>
...
整理 Clip Studio Paint 相關工具的索引，包含自己做的和覺得不錯的第三方工具。

<br><br>

<img src="https://img.shields.io/github/stars/RyuuMeow/csp-toolkit?label=Stars&style=flat-square&color=FFB454">
...
Windows 的放射狀快捷選單，靈感來自 Blender。可依不同應用程式設定不同選單，從游標位置叫出來，不用把手移離畫布。C++／Qt 開發。
...
<b>ClipStudioPaint-Grayscale-Viewer</b>
...
<b>SimpleProfileCard</b>

幾行 Python 生出個人名片網頁，支援從 GitHub、YouTube、Reddit 自動抓資料。

<code>pip install profilecard</code>

<br><br>

<img src="https://img.shields.io/github/stars/RyuuMeow/SimpleProfileCard?label=Stars&style=flat-square&color=FFB454">
...
<b>UE5-CPP-Doc-Searcher-Prompt</b>

在寫 UE5 C++ 時用來快速查文件的 Prompt 模板。

<br><br>

<img src="https://img.shields.io/github/stars/RyuuMeow/UE5-CPP-Doc-Searcher-Prompt?label=Stars&style=flat-square&color=FFB454">
...
<b>Alice-PERSONA-md</b>

女僕 Alice 的 AI 人設檔，丟給 AI 就能直接使用。

<br><br>

<img src="https://img.shields.io/github/stars/RyuuMeow/Alice-PERSONA-md?label=Stars&style=flat-square&color=FFB454">
...
<b>Gemini-Music-Generation_Prompt</b>

貼進 Gemini App 的 System Prompt，用簡單描述即可生成音樂並主動釐清風格。

<br><br>

<img src="https://img.shields.io/github/stars/RyuuMeow/Gemini-Music-Generation_Prompt?label=Stars&style=flat-square&color=FFB454">
...
![GitHub Snake](https://github.com/RyuuMeow/RyuuMeow/raw/main/dist/github-contribution-grid-snake.svg)
